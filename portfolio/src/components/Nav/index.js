    ...
    return (
        ...
        <nav className="navbar navbar-expand-lg bg-dark navbar-dark py-3 mb-4">
            <div className="container">
                ...
                <a href="#about" className="navbar-brand" onClick={() => handlePageChange('About')} >Jose Barreto</a>
                ...
                <div className="collapse navbar-collapse" id="navmenu">
                    <ul className="navbar-nav ms-auto ml-3">
                        <li className="nav-item">
                            <a href="#about" className={currentPage === 'Home' ? 'nav-link active' : 'nav-link'} onClick={() => handlePageChange('About')}> About </a>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                            ...
                            <a href="#portfolio" className={currentPage === 'Contact' ? 'nav-link active' : 'nav-link'} onClick={() => handlePageChange('Portfolio')} > Portfolio  </a>
                        </li>
